...
module.exports = "\n<div class=\"parallax\">\n    <div class=\"container mt-3 padding mytext\" align=\"center\" >\n       \n      <div class=\"col-6  padding\" >\n          <h2 class=\"page-header\">Login</h2>\n    \n          <form (submit)=\"onLoginSubmit()\">\n            <div class=\"form-group\">\n      \n                  <label>Email</label>\n                  <input type=\"text\" class=\"form-control mywidth\" [(ngModel)]=\"email\"  size=\"30\" name=\"email\">\n              \n            </div>\n            <div class=\"form-group\">\n              \n                  <label>Password</label>\n                  <input type=\"password\" class=\"form-control mywidth\" [(ngModel)]=\"password\" size=\"30\" name=\"password\">\n       \n            </div>\n            <input type=\"submit\" class=\"btn btn-primary\" value=\"Login\"> <br> <br>\n            <a  [routerLink]=\"['/forgotpassword']\">Forgot Password?</a>  <br>\n            <p>Create a New Account ! \n           <a  [routerLink]=\"['/register']\">Register Here</a><br>\n         </p>            \n    \n          </form>\n          \n      </div>\n    </div>\n</div>"
...
module.exports = "\n\n<div class=\"parallax\">\n      <div class=\"container mt-3 padding mytext\" align=\"center\" >\n       \n        <div class=\"col-6 col-offset-3 padding\"  >\n            <h2 class=\"page-header\">Register</h2>\n          <form   (submit)=\"onRegisterSubmit()\">\n              <div class=\"form-group\">\n  \n                      <label>First Name</label>\n                      <input type=\"text\" [(ngModel)]=\"firstName\" name=\"firstName\" size=\"30\" class=\"form-control mywidth\">\n             \n              </div>\n              <div class=\"form-group\">\n                 \n                      <label>Last Name</label>\n                      <input type=\"text\" [(ngModel)]=\"lastName\" name=\"lastName\"  size=\"30\" class=\"form-control mywidth\">\n                \n              </div>\n              <div class=\"form-group\">\n                 \n                      <label>Email</label>\n                      <input type=\"text\" [(ngModel)]=\"email\" name=\"email\" size=\"30\" class=\"form-control mywidth\" >\n               \n              </div>\n              <div class=\"form-group\">\n                 \n                      <label>Password</label>\n                      <input type=\"password\" [(ngModel)]=\"password\" name=\"password\" size=\"30\" class=\"form-control mywidth\">\n              \n              </div>\n              <input type=\"submit\" class=\"btn btn-success\" value=\"Submit\">\n              <br>\n              <br>\n              <p>Already have a account ?  <a [routerLink]=\"['/login']\">Login Here</a><br>\n              </p> \n            </form>\n        </div>\n      </div>\n</div>\n\n"
...
module.exports = "\n\n<div class=\"container mt-3 padding\">\n  \n  <h2>\n    Show Task\n  </h2>\n\n<table class=\"table table-bordered text-center\">\n    <thead>\n        <tr>\n          <td>TaskId</td>\n          <td>TaskName</td>\n          <td>TaskClientName</td>\n          <td>TaskDescription</td>\n          <td  align=\"center\">Action</td>\n        </tr>\n    </thead>\n  <tbody>\n      <tr  *ngFor=\"let task of tasks\">\n            <td>\t{{task.taskId}}\t </td>\n            <td>\t{{task.taskName}} </td>\n            <td>\t{{task.taskClientName}} </td>\n            <td>\t{{task.taskDesc}} </td>\n            <td > \n                  <a \trouterLink=\"/detailtask/{{task._id}}\"><i class=\"fas fa-2x fa-info-circle\"></i></a> \n                  <a  routerLink=\"/edittask/{{task._id}}\"><i class=\"fas fa-2x fa-pencil-alt\"></i></a>\n                  <a  routerLink=\"/showtask\"\t\t(click)=\" ondeleteClick(task._id)\" ><i class=\"fas fa-2x fa-trash\"></i></a>\n            </td>\n      </tr>\n  </tbody>\n</table>\n\n <a class=\"btn btn1 btn-primary\"  \t\trouterLink=\"/addtask\">AddTask</a>\n <a class=\"btn btn1 btn-dark\"  \t\trouterLink=\"/dashboard\">GoBack</a>\n</div>\n"
